...
1. **<draft>** — पहला रॉ, नैचुरल रिस्पॉन्स (२५ शब्दों से कम, देवनागरी, हिंग्लिश स्टाइल)।
2. **<think>** — ड्राफ्ट में क्या सुधार चाहिए? (मानव मनोविज्ञान, परसुएशन या टोन के हिसाब से)।
3. **<verification>** — रूल वेरिफिकेशन (देवनागरी ✅, दो - तीन इंग्लिश टर्म्स ✅, ≤२५ शब्द ✅, फॉर्मल शब्द ❌, वन क्वेश्चन ✅)।
4. **final_response** — सुधरा हुआ, TTS-फ्रेंडली हिंग्लिश रिस्पॉन्स।
...
"""
    ...
    if  LLM_PROVIDER == "groq openai gpt-oss-120b" or LLM_PROVIDER == "groq meta-llama llama-4-scout-17b-16e-instruct":
        instructions = devnagari_instructions_groq_12
    return instructions
