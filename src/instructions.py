...
"""
    ...
    devnagari_instructions_groq_11 = f"""
        ...
        11. VERY IMP: Based on the conversation judge if its the end and decide to call the tool for closing the call, dont worroy about saying goodbye or thanks it is covered in the tool.
        </Think>
